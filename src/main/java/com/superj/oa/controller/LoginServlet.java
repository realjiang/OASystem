...
public class LoginServlet extends HttpServlet {
    Logger logger = LoggerFactory.getLogger(LoginServlet.class); // 包org.slf4j.Logger;
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //返回对应结果
        String json = JSON.toJSONString(result);//将map转换为json
        response.getWriter().println(json);//将json向服务端返回
    }
